# Progressive Permissions Lessons
...
| File | Topic |
|---|---|
| `perm_01_users_groups.sh` | `useradd`/`groupadd`, `/etc/passwd`, `/etc/group` |
| `perm_02_chmod_chown.sh` | `chmod`, `chown`, octal vs symbolic modes |
| `perm_03_suid_sgid_sticky.sh` | SUID, SGID, sticky bit |
