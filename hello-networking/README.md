...
| File | Topic |
|---|---|
| `net_01_ip_basics.sh` | `ip addr`, `ip link` |
| `net_02_ip_routing.sh` | `ip route` |
| `net_03_network_namespaces.sh` | `ip netns` |
| `net_04_iptables_basics.sh` | `iptables` rules and chains |
