# Progressive Process Management Lessons
...
| File | Topic |
|---|---|
| `proc_01_ps_top.sh` | `ps`, `top`/`htop` basics |
| `proc_02_signals.sh` | `kill`, `trap`, common signals |
| `proc_03_proc_filesystem.sh` | `/proc/<pid>/...` internals |
